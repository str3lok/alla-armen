...
if (windowWidth<minWindowWidth) {    
    ...
    if (windowWidth <= 480) {
        $(imgLoader).html('<img src="images/bg10x480.jpg" alt="#" /><img src="images/bg2x480.jpg" alt="#" /><img src="images/bg4x480.jpg" alt="#" />');
    }
    else {
        $(imgLoader).html('<img src="images/bg10x768.jpg" alt="#" /><img src="images/bg2x768.jpg" alt="#" /><img src="images/bg4x768.jpg" alt="#" />');       
    }
    
}   
else {
    $(imgLoader).html('<img src="images/bg10.jpg" alt="#" /><img src="images/bg2.jpg" alt="#" /><img src="images/bg4.jpg" alt="#" />');       
}       
