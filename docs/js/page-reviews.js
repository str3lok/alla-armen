...
if (windowWidth<minWindowWidth) {    
    ...
    if (windowWidth <= 480) {
        $(imgLoader).html('<img src="images/bg7x480.jpg" alt="#" /><img src="images/bg2x480.jpg" alt="#" /><img src="images/bg3x480.jpg" alt="#" />');
    }
    else {
        $(imgLoader).html('<img src="images/bg7x768.jpg" alt="#" /><img src="images/bg2x768.jpg" alt="#" /><img src="images/bg3x768.jpg" alt="#" />');       
    }
    
}   
else {
    $(imgLoader).html('<img src="images/bg7.jpg" alt="#" /><img src="images/bg2.jpg" alt="#" /><img src="images/bg3.jpg" alt="#" />');       
}       
