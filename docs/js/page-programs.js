...
if (w<widthMin) {
    ...
    if (w <= 480) {
        var pictures = [
            { src : 'images/bg5x480.jpg'},
        	{ src : 'images/bg4x480.jpg'},
        	{ src : 'images/bg2x480.jpg'},
        ]; 
    }
    else {
        var pictures = [
            { src : 'images/bg5x768.jpg'},
        	{ src : 'images/bg4x768.jpg'},
...
if (windowWidth<minWindowWidth) {    
    ...
    if (windowWidth <= 480) {
        $(imgLoader).html('<img src="images/bg5x480.jpg" alt="#" /><img src="images/bg2x480.jpg" alt="#" /><img src="images/bg4x480.jpg" alt="#" />');
    }
    else {
        $(imgLoader).html('<img src="images/bg5x768.jpg" alt="#" /><img src="images/bg2x768.jpg" alt="#" /><img src="images/bg4x768.jpg" alt="#" />');       
    }            
    
}   
else {
    $(imgLoader).html('<img src="images/bg5.jpg" alt="#" /><img src="images/bg2.jpg" alt="#" /><img src="images/bg4.jpg" alt="#" />');       
}       
